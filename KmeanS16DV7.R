...
View(titanic)
write.csv(titanic,file = "C:/kmean/titanicnew.csv")
titanic<-read.csv("C:/kmean/titanicnew.csv")
...
titanicNew<-read.csv("C:/kmean/titanicNew.csv")
...
write.csv(titanicUpdated,file = "C:/kmean/titanicUpdated.csv")
